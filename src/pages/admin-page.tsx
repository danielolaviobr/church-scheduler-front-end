    ...
    <div id="admin-page">
      <div className="content-wrapper">
        ...
        <input
          ...
          onChange={(event) => setCelulaCapacity(event.target.value)}
        ></input>
        <button
        ...
        <input
          ...
          onChange={(event) => setGaleriaCapacity(event.target.value)}
        ></input>
        <button
          className="action-button"
        ...
        <div className="events">
          <Link to="/admin/galeria" className="event-button">
            Galeria
          </Link>
          <Link to="/admin/celula" className="event-button">
            Célula
          </Link>
        </div>
      </div>
